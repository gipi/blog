...
**Note:** take in consideration that in this post I'll use the definition
for the 32bit architectures, the 64bit one is different but the meaning
is the same; just keep in mind that corresponding structs could has the fields ordered
differently between different bit width, just saying ;)
