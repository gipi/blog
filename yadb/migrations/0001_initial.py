...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('yadb_blog', (
            ...
            ('modify_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('tags', self.gf('tagging.fields.TagField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('enable_comments', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('yadb', ['Blog'])


    def backwards(self, orm):
        # Deleting model 'Blog'
        db.delete_table('yadb_blog')
